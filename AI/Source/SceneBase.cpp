...
void SceneBase::Init()
{
	...
	meshList[GEO_MORNING] = MeshBuilder::GenerateQuad("morning", Color(1, 1, 1));
	meshList[GEO_MORNING]->textureID = LoadTGA("Image//morning.tga");
	meshList[GEO_GRID] = MeshBuilder::GenerateQuad("grid", Color(1, 1, 1));
	meshList[GEO_GRID]->textureID = LoadTGA("Image//grid30.tga");
	meshList[GEO_TEXT]->material.kAmbient.Set(1, 0, 0);
	meshList[GEO_GOBLIN] = MeshBuilder::GenerateQuad("goblin", Color(1, 1, 1));
	meshList[GEO_GOBLIN]->textureID = LoadTGA("Image//Sprites//goblin.tga");
	meshList[GEO_CAMP1] = MeshBuilder::GenerateQuad("camp1", Color(1, 1, 1));
	meshList[GEO_CAMP1]->textureID = LoadTGA("Image//Sprites//camp1.tga");
	meshList[GEO_CAMP2] = MeshBuilder::GenerateQuad("camp2", Color(1, 1, 1));
	meshList[GEO_CAMP2]->textureID = LoadTGA("Image//Sprites//camp2.tga");
	meshList[GEO_CAMP3] = MeshBuilder::GenerateQuad("camp3", Color(1, 1, 1));
	meshList[GEO_CAMP3]->textureID = LoadTGA("Image//Sprites//camp3.tga");
	meshList[GEO_CAMP4] = MeshBuilder::GenerateQuad("camp3", Color(1, 1, 1));
	meshList[GEO_CAMP4]->textureID = LoadTGA("Image//Sprites//camp4.tga");
	meshList[GEO_FISHFOOD] = MeshBuilder::GenerateQuad("fishfood", Color(1, 1, 1));
	meshList[GEO_FISHFOOD]->textureID = LoadTGA("Image//Sprites//fishfood.tga");
	meshList[GEO_SHARK] = MeshBuilder::GenerateQuad("shark", Color(1, 1, 1));
	meshList[GEO_SHARK]->textureID = LoadTGA("Image//Sprites//shark.tga");
	meshList[GEO_FISH] = MeshBuilder::GenerateQuad("fish", Color(1, 1, 1));
	meshList[GEO_FISH]->textureID = LoadTGA("Image//Sprites//fish.tga");
	meshList[GEO_FULL] = MeshBuilder::GenerateQuad("full", Color(1, 1, 1));
	meshList[GEO_FULL]->textureID = LoadTGA("Image//Sprites//full.tga");
	meshList[GEO_TOOFULL] = MeshBuilder::GenerateQuad("2full", Color(1, 1, 1));
	meshList[GEO_TOOFULL]->textureID = LoadTGA("Image//Sprites//toofull.tga");
	meshList[GEO_DEAD] = MeshBuilder::GenerateQuad("dead", Color(1, 1, 1));
	meshList[GEO_DEAD]->textureID = LoadTGA("Image//Sprites//dead.tga");
	meshList[GEO_HUNGRY] = MeshBuilder::GenerateQuad("hungry", Color(1, 1, 1));
	meshList[GEO_HUNGRY]->textureID = LoadTGA("Image//Sprites//hungry.tga");
